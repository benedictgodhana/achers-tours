...
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-slate-500" style="color:black">
  ...
  <a href="/contact" class="flex items-center">
    ...
    <h1 class="mb-4 text-center" style="font-size:18px;font-weight:bold">Our {{$tours->name}} Packages</h1>
        <p class="lead mb-4 text-center" style="font-size: 18px;">Welcome to our exciting selection of tours! Explore the best destinations with curated packages designed for every kind of traveler.</p>

    <div class="wrap">
    @foreach ($packages as $package)
    <div class="box transition duration-500 ease-in-out hover:scale-105 hover:shadow-lg opacity-0 animate-fade-in" >
    <div class="box-top" >
      <img class="box-image" src="{{ asset('storage/' . $package->image) }}" alt="Girl Eating Pizza" style="border-radius:30px">
      <div class="title-flex">
        <h3 class="box-title">{{ $package->name }}</h3>
      </div>
      <p class="description">{!! $package->description !!}</p>
    </div>
    <a href="" class="button">Make Enquiry</a>
  </div>
  @endforeach
</div>
    </section>
